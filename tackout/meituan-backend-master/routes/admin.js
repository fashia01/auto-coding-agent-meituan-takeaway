...
router.get('/user_info', Auth.auth, Admin.userInfo);           //获取用户信息
...
router.post('/address', Auth.auth, Admin.addAddress);      //添加收货地址
router.get('/all_address', Auth.auth, Admin.getAllAddress)        //获取用户所有地址
router.get('/address', Auth.authAdmin, Admin.getAddress);             //管理端获取所有地址
router.post('/update_address', Auth.auth, Admin.updateAddress);   //更新地址
router.delete('/address', Auth.auth, Admin.deleteAddress);      //删除收获地址
