...
const router = new Router({
  routes: [
    ...
    },
    {
      path: '/my_footprint',
      name: '我的足迹',
      component: r => require.ensure([], () => r(require('@/views/home/children/footprint'), 'MyFootprint'))
    },
    {
      path: '/my_collection',
      name: '我的收藏',
      component: r => require.ensure([], () => r(require('@/views/home/children/collection'), 'MyCollection'))
    },
    {
      path: '/make_comment',
      name: '评价订单',
