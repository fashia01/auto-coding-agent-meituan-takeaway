...
#address {
  ...
  background: #f4f4f4;
  .container ul li {
    position: relative; padding: 0.2rem; background: #fff;
    p { font-size: 0.4rem; font-weight: 600; margin: 0.1rem 0; }
    span { color: #848484; font-size: 0.3rem; &:nth-of-type(2) { margin: 0 0.2rem 0 0.1rem; } }
    .icon-select { font-size: 0.7rem; position: absolute; top: 50%; right: 0.1rem; transform: translateY(-50%); color: $mtYellow; }
  }
  .empty-address {
  ...
  .add {
    width: 100%; position: fixed; bottom: 0; text-align: center; background: #fff;
    @include px2rem(line-height, 100); border-top: 1px solid $mtGrey; border-bottom: 1px solid $mtGrey;
