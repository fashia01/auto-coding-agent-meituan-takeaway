...
.error {
  ...
  .info-container {
    ...
    .tip { display: block; margin: 0.1rem; font-size: 0.35rem; }
    .redirect-index { display: flex; justify-content: center; align-items: center; width: 3rem; height: 1rem; margin: 0.3rem 0; background: $mtYellow; span { font-size: 0.3rem; } }
  }
  .service { width: 100%; position: absolute; bottom: 10px; left: 0; text-align: center; span { font-size: 0.3rem; text-decoration: underline; } }
}
</style>
