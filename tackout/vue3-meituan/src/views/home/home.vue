...
const myAssetsList = [
  ...
  { name: '钱包', picUrl: 'http://p1.meituan.net/50.0.100/xianfu/2c14b3425c7bf1f3d63d11f47a7ef9ea2230.jpg' },
...
.assets, .intro {
  ...
  ul { display: flex; padding: 0.3rem 0; li { flex: 1; text-align: center; .img { @include px2rem(width, 55); @include px2rem(height, 55); margin: 0.1rem auto; img { width: 100%; height: 100%; } } span { font-size: 0.35rem; } } }
}
